	...
	<section class="login_box_area section_gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						...
						<div class="hover">
							...
							<p>Crie uma conta e não deixe de perder nenhuma novidade!</p>
							<a class="primary-btn" href="registration.html">Criar conta</a>
						</div>
					</div>
				</div>
				...
				<form class="row login_form" action="salva_dados.php?operacao=cad_usuario" method="POST" >

					<div class="login_form_inner">
						<h3>CRIE SUA CONTA</h3>
						

						<form  action="salva_dados.php" method="POST" >
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="nome" name="nome" placeholder="Nome " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Nome'">
                            </div>
                            <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="sobrenome" name="sobrenome" placeholder="Sobrenome" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Sobrenome'">
							</div>
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="email" name="email" placeholder="Email" onfocus="this.placeholder = ''" onblur="this.placeholder = '@Exemplo.com'">
                            </div>
                            <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="cpf" name="cpf" placeholder="CPF" onfocus="this.placeholder = ''" onblur="this.placeholder = 'CPF'">
                            </div>
                            <div class="col-md-12 form-group">
							...
							<div class="col-md-12 form-group">
								<div class="creat_account">
									<input type="checkbox" id="termos" name="selector">
									<label for="f-option2">Aceito os termos de uso do site DimarES</label>
								</div>
							</div>
							<div class="col-md-12 form-group">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Dimar Esportes Todos os direitos reservados </i> by <a href="https://colorlib.com" target="_blank">Dimar</a>
