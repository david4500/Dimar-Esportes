				...
				<div class="container">
					...
					<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
						<ul class="nav navbar-nav menu_nav ml-auto">
							<li class="nav-item active"><a class="nav-link" href="index.php">Página inicial</a></a></li>
						...
						<div class="row single-slide align-items-center d-flex">
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									<h1>Nike Stefan Janoski</h1>
									<p>O tênis NIKE SB ZOOM STEFAN JANOSKI CANVAS é um modelo ímpar. Autêntico que além de combinar o visual com sua ótima proteção contra impactos esta peça carrega todo o contexto e história do lendário skatista.s</p>
									<div class="add-bag d-flex align-items-center">
										<a class="add-btn" href=""><span class="lnr lnr-cross"></span></a>
										<span class="add-text text-uppercase">Adicionar ao orçamento</span>
									</div>
								</div>
							</div>
							<div class="col-lg-7">
								<div class="banner-img">
									<img class="img-fluid" src="img/banner/nike2.png" alt="">
								</div>
							</div>
						</div>
						<!-- single-slide -->
						<div class="row single-slide align-items-center d-flex">
							<div class="col-lg-5 col-md-6">
								<div class="banner-content">
									...
									<p>Artigos esportivos de varias marcas você encontra aqui na Dimar Esportes </p>
									<div class="add-bag d-flex align-items-center">
										<a class="add-btn" href=""><span class="lnr lnr-cross"></span></a>
										<span class="add-text text-uppercase">Adicionar ao orçamento</span>
									</div>
							...
							<div class="col-lg-7">
								<div class="banner-img">
									<img class="img-fluid" src="img/banner/jogador.png" alt="" >
								</div>
							</div>
						</div>
					</div>
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
							...
							<div class="product-details">
								...
								<a href="" class="social-info">
									...
									<a href="" class="social-info">
										...
										<p class="hover-text">Visualizar</p>
									</a>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
						<a href="single-product.php"><img class="img-fluid" src="img/product/mercurial.png" alt=""></a>
							<div class="product-details">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="single-product">
						<a href="single-product.php"><img class="img-fluid" src="img/product/p8.jpg" alt=""></a>
							<div class="product-details">
								<h6>addidas New Hammer sole
									for Sports person</h6>
								<div class="price">
