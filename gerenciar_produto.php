...
<div class="col-md-12 form-group">
			...
			<a class="primary-btn" href="cadastro_produto.php">Cadastrar produto</a>						
		</div>
...
<?php 
    ...
    $sql = "SELECT imagem, id, nome, categoria, descricao, preco, quantidade FROM produto";
	...
	if($result->num_rows > 0){
		while($linha = $result->fetch_assoc()){
			...
			echo "<td> <a href='salva_dados.php?operacao=exc_produto&id=" . $linha["id"] . "'>Excluir </a>" ;
			echo "<a href='cadastro_produto.php?operacao=edt&id=" . $linha["id"] . "'> Alterar</a>";
			echo "</tr>";
		}
	}else{
		echo "Nao existem produtos cadastrados.";
	}
