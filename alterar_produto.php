...
<body>
	...
	<div class="product_image_area">
		<div class="container">
				<form class="row login_form" action="salva_dados.php?operacao=alt_produto" method="POST">

					
					<div class="s_product_text">
						<h3>Buscar produto</h3>
							<form class="row login_form" action="busca_produto.php" method="post" id="contactForm" novalidate="novalidate">
