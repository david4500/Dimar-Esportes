...
<body>
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<li class="nav-item submenu dropdown active">
								...
								<ul class="dropdown-menu">
									...
									<li class="nav-item"><a class="nav-link" href="gerenciar_produto.php">Gerenciar produto</a></li>
								</ul>
							</li>
    ...
    <div class="product_image_area">
		<div class="container">
				<form class="row login_form" action="salva_dados.php?operacao=exc_produto" method="POST">

					
					<div class="s_product_text">
						<h3>Excluir produto</h3>
							<form class="row login_form" action="salva_dados.php" method="post" id="contactForm" novalidate="novalidate">
								<div class="col-md-12 form-group">
									<input type="text" class="form-control" id="id" name="id" placeholder="Id do produto " >
                           		</div>
                            	
							
								<div class="col-md-12 form-group">
									<button type="submit" value="submit" class="primary-btn">Buscar</button>
